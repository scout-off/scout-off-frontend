...
const SECRET_KEY = process.env.STELLAR_SECRET_KEY || "SDAV7XESHT63OQQ3Q6L27W462O4ZORZCOV4UOOXF6S2A6SST2YJXY63G";
...
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: "Invalid challenge transaction" }, { status: 401 });
  }
}
